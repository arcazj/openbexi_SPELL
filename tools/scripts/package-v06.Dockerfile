...
RUN groupadd --gid 10003 spell-package \
    ...
    && mkdir -p /workspace/artifacts/v0.6 \
    && chown -R spell-package:spell-package /workspace/artifacts/v0.6

USER 10003:10003

CMD ["python", "scripts/build_reproducible_v06.py", "--output", "artifacts/v0.6/openbexi-spell-v0.6.0.tar.gz"]
