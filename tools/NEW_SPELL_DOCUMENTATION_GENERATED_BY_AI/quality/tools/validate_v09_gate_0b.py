#!/usr/bin/env python3
"""Validate the evidence-bound SPELL v0.9 Gate 0B closeout decision."""
...
GATE_DOCUMENT_PATH = WORKSPACE_ROOT / "SPELL_v0.9_Gate_0B.md"
RELEASE_DOCUMENT_PATH = WORKSPACE_ROOT / "SPELL_v0.9_Release.md"
EVIDENCE_PATH = WORKSPACE_ROOT / "artifacts/v0.9/work-package/qualification.json"
EVIDENCE_VALIDATOR_PATH = WORKSPACE_ROOT / "scripts/validate_candidate_evidence_v09.py"
ACTIVATION_LOCK_RELATIVE = Path(
    "NEW_SPELL_DOCUMENTATION_GENERATED_BY_AI/requirements/compatibility/scopes/"
    ".v0.9-gate-0b-activation.lock"
)

SCHEMA_VERSION = "ng-spell-v09-gate-0b-scope/1"
EVIDENCE_SCHEMA = "spell.v09.candidate-qualification/1"
SCOPE_PROFILE = "LOCAL_SYNTHETIC_NON_CUI_DEVELOPMENT_ENVIRONMENT"
GATE_0A_COMMIT = "92f3b4b82908d44e28b9506749e498386a428c27"
GATE_0A_PARENT = "d6e01222de3bf52013279e48a099b6ae7ded121d"
GATE_0A_TREE = "e6b90f1e277f905a1d885008262916d86d6cdceb"
GATE_0A_MARKER = (
...
WORK_PACKAGE_TEST_IDS: dict[str, tuple[str, ...]] = {
    "V09-DEV-001": (
        "V09-DEV-001-CONTRACT", "V09-DEV-001-PROJECT-LIFECYCLE",
        "V09-DEV-001-WORKSPACE-RACE", "V09-DEV-001-BROWSER", "V09-DEV-001-SECURITY",
    ),
    "V09-DEV-002": (
    ...
    "V09-DEV-008": (
        "V09-DEV-008-STATE-MACHINE", "V09-DEV-008-AUTHORIZATION", "V09-DEV-008-TRANSACTION-AUDIT",
        "V09-DEV-008-ROLLBACK-WITHDRAWAL", "V09-DEV-008-PINNING",
    ),
    "V09-DEV-009": (
...
GATE_FILES = {
    "SPELL_v0.9_Pre-Implementation.md": {
        "blob": "c4265214447c052ac2054c404ff70494475d9217",
        "sha256": "9ed958fa2141e950defc5dd36e4c3fcfc4dc0f5bd2763340c6d32cb29a612511",
    },
    (
        "NEW_SPELL_DOCUMENTATION_GENERATED_BY_AI/requirements/compatibility/"
        "scopes/v0.9-gate-0a.json"
    ): {
        "blob": "409ff99af6219a49bce4d9772dac977d503e60b1",
        "sha256": "c333f458bfb3eb965f59f6d2718eb317bf79c716b89596d746e30b72f6fb8e00",
    },
    (
        "NEW_SPELL_DOCUMENTATION_GENERATED_BY_AI/quality/tools/"
        "validate_v09_gate_0a.py"
    ): {
        "blob": "c6390654db14f14f28fcbd33db260f04ae04479c",
        "sha256": "247825a429c572a9eed2984e144039ebfd9e75cad19ac776274b065cc92a176b",
    },
    (
        "NEW_SPELL_DOCUMENTATION_GENERATED_BY_AI/quality/tools/"
        "test_validate_v09_gate_0a.py"
    ): {
        "blob": "a60ee97871396ba48a4a62749b3db7be0e322c5d",
        "sha256": "da818362a3e6e7549d329101fb569a637b75aa79f47f4c300134245f622e59a8",
    },
}

CONTRACT_FILES = {
    "contracts/v09/manifest.json": (
        "65b01182d097e4654513ee9ab1c25d95886addf6",
        "ce27b6b7d84ffbb3663ebee85befa89d1a765adfe2fc5fab7de24401e0d6c6de",
    ),
    "contracts/v09/project_workspace.json": (
        "afee3f966331398c797349855834897a2eb5bbed",
        "1972deab80d78fde2760004fd0a545b62dd2cbc530ea2a12ee29f2d81f32745c",
    ),
    "contracts/v09/language_services.json": (
        "3126e8b84482c8464a979282bc899102980d83da",
        "628abeade69458149217bd30f5fff8f5810c708fc11eb08ba0d3a1c4379cf97a",
    ),
    "contracts/v09/dictionary_catalog_authoring.json": (
        "3fa350ae854674dc9df78f32b7113eb7940f0604",
        "30976e5b93d40437ed42b2e38371b39603ae81b82be3a703e453083d30b5a090",
    ),
    "contracts/v09/semantic_checks.json": (
        "8c61c7da3fd68600a8f2d858eadf5360407c976f",
        "8cb4fc54b147e54a77d615bd3070068de2f70729d9887664df26557bbf8b8a66",
    ),
    "contracts/v09/import_export_external_changes.json": (
        "d2e8afe12af27e378352dd2c8311939eb2ae5539",
        "6faf3897cdd2baecf193320c42f273c925e783acfeec9bc8fffcda3af039efbd",
    ),
    "contracts/v09/collaboration_history.json": (
        "d22fa8e18b5633d0d884abf9a6588e4cd850c502",
        "fd7c0b5d6ee82ed57b9d23ac816428503987482ff6a53d29a941099b2308ed32",
    ),
    "contracts/v09/immutable_bundles.json": (
        "45b881f5c443baed01482d8a3f48a30903a6a46b",
        "232ab4a2094db8ee1a7bf840401a153b297f9c6e5d3c1924cb0c44e63889637e",
    ),
    "contracts/v09/promotion_registry.json": (
        "d1ac7775b389b50c3b6c3e15019fd1597e314c23",
        "1e98e28770047af36899c1db6b4db1355f70503ffd030f155f1de680d83f6972",
    ),
}

BASELINE = {
    "tag_ref": "refs/tags/v0.8.0",
    "tag_object_type": "tag",
    "tag_object_id": "0dcf4f539fd1a9036fe4db4bc159cde04c35cfae",
    "raw_tag_object_sha256": "c609c25cb8987222df0b143f71aa792140171acffd454e31a760c16fb263eede",
    "peeled_release_commit": GATE_0A_PARENT,
    "qualified_source_commit": "d80c4d43969018633bc17650a23412b7274e58ea",
    "tagged_files_sha256": {
        "SPELL_v0.8_Release.md": (
            "37735796cd6b3ee968950c447382aea4ede28255244e772975b06d12ee5592cd"
        ),
        (
            "NEW_SPELL_DOCUMENTATION_GENERATED_BY_AI/requirements/compatibility/"
            "scopes/v0.8-gate-0b.json"
        ): "0e3e3fc2eea47d243f67cdc802a14d93e9053c1cf4f75fc1ab0c300392d36d0c",
...
DEVELOPMENT_SERVICE_FILES = (
    "backend/development_domain.py",
    "backend/development_analysis.py",
    "backend/development_models.py",
    "backend/development_service.py",
    "backend/development_api.py",
    "backend/procedure_parser.py",
    "backend/app.py",
)

FRONTEND_SURFACE_FILES = (
    "frontend/development.html",
    "frontend/vite.config.ts",
    "frontend/src/development/main.tsx",
    "frontend/src/development/DevelopmentApp.tsx",
    "frontend/src/development/DevelopmentWorkspace.tsx",
    "frontend/src/development/api.ts",
    "frontend/src/development/types.ts",
)

FEATURE_FAMILIES = (
    "PROJECT_WORKSPACE_AND_RESOURCE_LIFECYCLE",
    "NON_EXECUTING_LANGUAGE_SERVICES",
    "DICTIONARY_AND_CATALOG_AUTHORING",
    "SEMANTIC_CHECKS_AND_PROBLEMS",
    "SAFE_IMPORT_EXPORT_AND_EXTERNAL_CHANGE",
    "LOCAL_HISTORY_AND_COLLABORATION",
    "IMMUTABLE_VALIDATED_BUNDLES",
    "LOCAL_SIMULATOR_PROMOTION_REGISTRY",
)

CLOSEOUT_ACTIONS = (
    "RECORD_V09_DEV_001_THROUGH_V09_DEV_009_IMPLEMENTED",
    ...
    "CREATE_DETERMINISTIC_V0_9_RELEASE_PACKAGE",
    "COMMIT_RELEASE_CLOSEOUT",
    "CREATE_ONE_ANNOTATED_V0_9_0_TAG",
)
...
REQUIRED_TRANSITIONS = {
    "/status": "PASS",
    "/decision/authorization": "V09_DEV_001_THROUGH_V09_DEV_009_RELEASE_CLOSEOUT_ONLY",
...
EXCLUSIONS = (
    "SCOPE_BEYOND_V09_DEV_001_THROUGH_V09_DEV_009",
    ...
    "UNBOUNDED_PROJECT_RESOURCE_DIAGNOSTIC_HISTORY_BUNDLE_QUERY_TRANSACTION_RETRY_QUOTA_OR_RETENTION",
    "SILENT_COERCION_AMBIGUOUS_FORMAT_BEST_EFFORT_CORRUPTION_RECOVERY_LAST_WRITER_WINS_OR_PARTIAL_WRITE_SUCCESS",
    "AMBIGUOUS_EXTERNAL_CHANGE_CONFLICT_PROMOTION_OR_ROLLBACK_RESOLUTION",
    ...
    "LIGHTWEIGHT_SECONDARY_OR_V0_9_ALIAS_TAG",
...
def _gate_record_body(scope: Mapping[str, Any]) -> str:
    ...
    if state == "PASS":
        gate_status = "`PASS`; exact v0.9 release closeout authorized"
        candidate_value = (
        ...
        decision = "V09_DEV_001_THROUGH_V09_DEV_009_RELEASE_CLOSEOUT_ONLY"
        authorization = "AUTHORIZED"
    else:
        gate_status = "`PENDING_CANDIDATE`; no release closeout authorization yet"
        candidate_value = (
            "Exact source and product inventory frozen; candidate commit pending"
        )
        evidence_value = (
            "Pending at `artifacts/v0.9/work-package/qualification.json`"
        )
        decision = "PENDING_CANONICAL_V09_CANDIDATE_QUALIFICATION"
    ...
    return "\n".join(
        (
            ...
            f"| Accepted product baseline | Annotated tag `v0.8.0`; release commit `{GATE_0A_PARENT}` |",
            f"| Gate 0A authorization | Commit `{GATE_0A_COMMIT}`; `V09-DEV-001` through `V09-DEV-009` |",
...
def _gate_finding_body(state: str) -> str:
    if state == "PASS":
        return (
            "`V09-GATE-0B PASS` authorizes release closeout for exactly "
            "`V09-DEV-001` through `V09-DEV-009`. It does not itself accept the "
...
def _release_evidence_body(scope: Mapping[str, Any], scope_sha256: str) -> str:
    ...
    return "\n".join(
        (
            ...
            "| --- | --- | --- |",
            f"| Candidate qualification | `artifacts/v0.9/work-package/qualification.json` | {candidate_value} |",
            f"| Gate 0B machine scope | `.../scopes/v0.9-gate-0b.json` | {gate_value} |",
...
def _release_finding_body(state: str) -> str:
    if state == "PASS":
        return (
            "Gate 0B has passed for the exact nine-package v0.9 candidate, but SPELL "
            "v0.9.0 is not yet accepted by this record. Final qualification, supply-chain "
...
def render_activation_documents(
    ...
    release_text, release_newline = _normalized_document(
        release_path, "v0.9 release document"
    )
...
def _validate_decision(scope: Mapping[str, Any], state: str) -> None:
    ...
    _exact(decision["decision_date"], "2026-08-18", "decision.decision_date")
    ...
    _exact(
        ...
        "REQUESTED_V0_9_RESOLVES_TO_ONE_ANNOTATED_SEMVER_TAG_V0_9_0",
        "decision.tag_resolution",
    )
    _exact(
        decision["precondition"],
        "CANONICAL_V09_CANDIDATE_QUALIFICATION_AND_GATE_0B_VALIDATOR_PASS",
        "decision.precondition",
    )
    expected = (
        "PENDING_V09_DEV_001_THROUGH_V09_DEV_009_RELEASE_CLOSEOUT"
        if state == "PENDING_CANDIDATE"
        else "V09_DEV_001_THROUGH_V09_DEV_009_RELEASE_CLOSEOUT_ONLY"
    )
...
def _validate_immutable_inputs(scope: Mapping[str, Any], state: str) -> None:
    ...
    _exact_keys(inputs, {"accepted_v0_8_0", "gate_0a", "candidate"}, "immutable_inputs")
    _exact(inputs["accepted_v0_8_0"], BASELINE, "accepted v0.8.0 binding")
...
def _validate_qualification_contract(scope: Mapping[str, Any], state: str) -> None:
    ...
    _exact(contract["manifest_path"], "artifacts/v0.9/work-package/qualification.json", "manifest path")
    _exact(contract["manifest_schema"], EVIDENCE_SCHEMA, "manifest schema")
    _exact(contract["validator_path"], "scripts/validate_candidate_evidence_v09.py", "validator path")
...
def _validate_reviewed_delta(scope: Mapping[str, Any], state: str) -> None:
    ...
    _exact_keys(
        delta,
        {
            "review_status", "development_surface", "accepted_boundaries",
            "database_schema", "dependencies", "compatibility_ledger",
        },
    ...
    surface = _mapping(delta["development_surface"], "reviewed_surface_delta.development_surface")
    _exact(surface, {
        "api_version": "v1",
        "route_prefix": "/api/v1/development",
        "classification": "BOUNDED_AUTHENTICATED_LOCAL_DEVELOPMENT_ENVIRONMENT",
        "feature_families": list(FEATURE_FAMILIES),
        "service_boundary_files": list(DEVELOPMENT_SERVICE_FILES),
        "frontend_surface_files": list(FRONTEND_SURFACE_FILES),
        "frontend_entrypoint": "/development.html",
        "authorization_before_lookup_or_body_read": True,
        "transactional_audit_outbox": True,
        "procedure_language_services_are_non_executing": True,
        "browser_has_no_direct_database_or_filesystem_access": True,
        "arbitrary_expression_evaluation": False,
        "broad_public_api_compatibility_claimed": False,
    }, "development surface delta")

    boundaries = _mapping(delta["accepted_boundaries"], "reviewed_surface_delta.accepted_boundaries")
    _exact(boundaries, {
        "accepted_v08_artifacts_immutable": True,
        "gate_0a_contract_blobs_immutable": True,
        "legacy_driver_protocol_bytes_unchanged": True,
        "legacy_ir_serialized_bytes_unchanged": True,
        "live_driver_or_external_effect_route_added": False,
    }, "accepted boundary delta")

    database = _mapping(delta["database_schema"], "reviewed_surface_delta.database_schema")
    _exact(database, {
        "migration_versions": list(MIGRATION_TABLES),
        "migration_files": [
            "backend/migrations/versions/v0008_development_environment.py",
        ],
    ...
    _exact(compatibility, {"claimed_construct_ids": [], "claimed_artifact_ids": [], "compatibility_ledger_rows_added": 0, "v0_8_scope_rows_changed": 0, "broad_compatibility_claimed": False}, "compatibility ledger delta")
...
def _validate_closeout_and_claims(scope: Mapping[str, Any], state: str) -> None:
    ...
    _exact(closeout["release_version"], "0.9.0", "release closeout version")
    _exact(closeout["tag_name"], "v0.9.0", "release tag")
    ...
    _exact_keys(claims, {"v0_8_release_accepted", "gate_0a_immutable_authorization_verified", "v0_9_work_packages_implemented", "v0_9_candidate_qualified", "release_closeout_authorized", "v0_9_release_accepted_by_gate", "broad_language_or_compatibility_claimed", "operational_authorization", "deployment_approval", "compliance_determination", "cryptographic_signature_verified"}, "claims")
    _exact(claims["v0_8_release_accepted"], True, "v0.8 release claim")
    _exact(claims["gate_0a_immutable_authorization_verified"], True, "Gate 0A verification claim")
    implemented = state == "PASS"
    for key in ("v0_9_work_packages_implemented", "v0_9_candidate_qualified", "release_closeout_authorized"):
        _exact(claims[key], implemented, f"claims.{key}")
    for key in ("v0_9_release_accepted_by_gate", "broad_language_or_compatibility_claimed", "operational_authorization", "deployment_approval", "compliance_determination", "cryptographic_signature_verified"):
...
def validate_scope(scope: Any) -> str:
    ...
    _exact(scope["gate_id"], "V09-GATE-0B", "gate identity")
    _require(scope["status"] in {"PENDING_CANDIDATE", "PASS"}, "gate status is invalid")
    state = scope["status"]
    _exact(scope["target_increment"], "v0.9", "target increment")
    _exact(scope["target_release"], "v0.9.0", "target release")
...
def _validate_baseline(root: Path) -> None:
    ...
    _exact(ref_type, "tag", "v0.8.0 tag object type")
    object_id = _git(root, ["rev-parse", BASELINE["tag_ref"]])
    _exact(object_id, BASELINE["tag_object_id"], "v0.8.0 tag object")
    raw_tag = _git(root, ["cat-file", "tag", object_id], binary=True)
    assert isinstance(raw_tag, bytes)
    _exact(sha256_bytes(raw_tag), BASELINE["raw_tag_object_sha256"], "v0.8.0 raw tag hash")
    peeled = _git(root, ["rev-parse", f"{BASELINE['tag_ref']}^{{}}"])
    _exact(peeled, GATE_0A_PARENT, "v0.8.0 peeled commit")
    text = raw_tag.decode("utf-8")
    for marker in REQUIRED_TAG_MARKERS:
        _require(text.splitlines().count(marker) == 1, f"v0.8.0 tag marker differs: {marker}")
    for path, digest in BASELINE["tagged_files_sha256"].items():
        _, raw = _git_blob(root, GATE_0A_PARENT, path)
        _exact(sha256_bytes(raw), digest, f"v0.8.0 tagged file hash: {path}")
...
def _validate_gate_0a(root: Path) -> None:
    ...
    _, gate_doc = _git_blob(root, GATE_0A_COMMIT, "SPELL_v0.9_Pre-Implementation.md")
    _require(OWNER_MARKER in gate_doc.decode("utf-8").splitlines(), "Gate 0A owner marker is absent")
    _, scope_raw = _git_blob(root, GATE_0A_COMMIT, next(path for path in GATE_FILES if path.endswith("v0.9-gate-0a.json")))
    ...
    _, manifest_raw = _git_blob(root, GATE_0A_COMMIT, "contracts/v09/manifest.json")
    manifest = strict_json_bytes(manifest_raw, "committed v0.9 contract manifest")
    _exact(manifest.get("work_packages"), list(WORK_PACKAGE_TEST_IDS), "contract work-package inventory")
    matrix_paths = [f"contracts/v09/{item['file']}" for item in manifest.get("matrices", [])]
...
def _development_model_table_names(raw: bytes) -> tuple[str, ...]:
    tree = ast.parse(raw.decode("utf-8"), filename="development_models.py")
    names: list[str] = []
    for node in tree.body:
    ...
    _exact(
        tuple(names),
        MIGRATION_TABLES["0008_development_environment"],
        "development model table inventory",
    )
    return tuple(names)
...
def _validate_candidate_git(root: Path, scope: Mapping[str, Any]) -> None:
    ...
    surface = scope["reviewed_surface_delta"]["development_surface"]
    for path in surface["service_boundary_files"] + surface["frontend_surface_files"]:
        _git_blob(root, commit, path)
    _, development_api = _git_blob(root, commit, "backend/development_api.py")
    _require(
        f'APIRouter(prefix="{surface["route_prefix"]}"' in development_api.decode("utf-8"),
        "candidate development API route prefix is absent",
    )
    _, entrypoint = _git_blob(root, commit, "frontend/development.html")
    _require(
        b"src/development/main.tsx" in entrypoint,
        "candidate development frontend entrypoint differs",
    )
    ...
    for marker in (
        ...
        _require(marker in migration_text, f"development migration binding is absent: {marker}")
    _, models = _git_blob(root, commit, "backend/development_models.py")
    _development_model_table_names(models)
...
def _validate_manifest_contract(manifest: Mapping[str, Any], candidate: str) -> None:
    ...
    _exact(manifest.get("product_version"), "0.9.0-candidate", "candidate evidence product version")
...
def activate_scope_bindings(
    ...
    *,
    ...
    scope["decision"]["authorization"] = (
        "V09_DEV_001_THROUGH_V09_DEV_009_RELEASE_CLOSEOUT_ONLY"
    )
    ...
    for key in (
        "v0_9_work_packages_implemented",
        "v0_9_candidate_qualified",
...
def apply_activation(
    ...
    target_paths = (
        scope_path,
        root / "SPELL_v0.9_Gate_0B.md",
        root / "SPELL_v0.9_Release.md",
    )
...
def validate_gate_document(
    ...
    _exact(first, "# SPELL v0.9 Gate 0B Release Closeout", "Gate 0B document heading")
    common = (
        f"Owner request: `{OWNER_REQUEST}`",
        "Release acceptance by Gate 0B: No",
        "Operational authorization: None",
...
def validate_release_document(path: Path, scope: Mapping[str, Any]) -> None:
    text, _ = _normalized_document(path, "v0.9 release document")
    state = scope["status"]
    _exact(
        next((line for line in text.splitlines() if line.strip()), ""),
        "# SPELL v0.9.0 Release Record",
        "v0.9 release document heading",
    )
    scope_sha256 = sha256_bytes(canonical_scope_bytes(scope))
    for markers, expected, label in (
        (RELEASE_RECORD_MARKERS, _release_record_body(scope), "release conditional record"),
...
def validate_repository(scope_path: Path = SCOPE_PATH, root: Path = WORKSPACE_ROOT) -> tuple[str, dict[str, Any]]:
    ...
    validate_gate_document(root / "SPELL_v0.9_Gate_0B.md", state, scope)
    validate_release_document(root / "SPELL_v0.9_Release.md", scope)
    if state == "PASS":
