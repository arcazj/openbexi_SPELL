...
RUN groupadd --gid 10003 spell-package \
    ...
    && mkdir -p /workspace/artifacts/v0.8 \
    && chown -R spell-package:spell-package /workspace/artifacts/v0.8

USER 10003:10003

CMD ["python", "scripts/build_reproducible_v08.py", "--output", "artifacts/v0.8/openbexi-spell-v0.8.0.tar.gz"]
