...
RUN groupadd --gid 10003 spell-package \
    ...
    && mkdir -p /workspace/artifacts/v0.4 \
    && chown -R spell-package:spell-package /workspace/artifacts/v0.4

USER 10003:10003

CMD ["python", "scripts/build_reproducible_v04.py", "--output", "artifacts/v0.4/openbexi-spell-v0.4.tar.gz"]
