...
RUN groupadd --gid 10003 spell-package \
    ...
    && mkdir -p /workspace/artifacts/v0.9 \
    && chown -R spell-package:spell-package /workspace/artifacts/v0.9

USER 10003:10003

CMD ["python", "scripts/build_reproducible_v09.py", "--output", "artifacts/v0.9/openbexi-spell-v0.9.0.tar.gz"]
