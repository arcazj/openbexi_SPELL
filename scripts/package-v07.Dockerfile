...
RUN groupadd --gid 10003 spell-package \
    ...
    && mkdir -p /workspace/artifacts/v0.7 \
    && chown -R spell-package:spell-package /workspace/artifacts/v0.7

USER 10003:10003

CMD ["python", "scripts/build_reproducible_v07.py", "--output", "artifacts/v0.7/openbexi-spell-v0.7.0.tar.gz"]
