...
| v0.10 | Release policy in `contracts/v10/release_policy.json` | [Implementation and conditional release record](SPELL_v0.10_Implementation.md) |
| v0.11 | Planned in the root roadmap after accepted v0.10 | Not present in the v0.10 release tree |
