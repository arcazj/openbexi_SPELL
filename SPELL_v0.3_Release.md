...
- [Typed-language validation console](artifacts/v0.3/desktop-v03-validation.png)
- [Desktop as-run report](artifacts/v0.3/desktop-as-run-report.png)
- [Mobile recovered prompt](artifacts/v0.3/mobile-recovered-prompt.png)
